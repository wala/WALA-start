...
public class JSCallGraphBuilderUtil extends com.ibm.wala.cast.js.ipa.callgraph.JSCallGraphUtil {
  ...
  public static JSCFABuilder makeHTMLCGBuilder(URL url, Supplier<JSSourceExtractor> fExtractor) throws IOException, WalaException {
    return makeHTMLCGBuilder(url, CGBuilderType.ZERO_ONE_CFA, fExtractor);
  }

  public static JSCFABuilder makeHTMLCGBuilder(URL url, CGBuilderType builderType,
      Supplier<JSSourceExtractor> fExtractor) throws IOException, WalaException {
  ...
  public static CallGraph makeHTMLCG(URL url, Supplier<JSSourceExtractor> fExtractor) throws IOException, IllegalArgumentException, CancelException, WalaException {
  ...
  public static CallGraph makeHTMLCG(URL url, CGBuilderType builderType,
      Supplier<JSSourceExtractor> fExtractor) throws IOException, IllegalArgumentException,
      CancelException, WalaException {
